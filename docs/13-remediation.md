...
- **Déploiement** — cron `vercel.json` quotidien (limite Hobby) + cron externe pour la réactivité (`docs/15-cron.md`), HTTPS, `scripts/smoke.sh` vert après chaque mise en prod. Runbook §3–4.
